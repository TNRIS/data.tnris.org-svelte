    ...
    {:else}
      ...
      {#if collection.wms_link}
        <section class="metadata-section">
          ...
          <p>
            For ESRI users accessing our RESTful Services hosted on our ArcGIS server (feature.tnris.org or imagery.tnris.org), you may access all WMS services available by downloading our <a href="https://cdn.tnris.org/data/RESTful_Services/TNRIS_RESTful_Services.zip" download>feature and imagery connection files</a> and selecting from the list of availabile services within your ESRI desktop software.
          </p>
